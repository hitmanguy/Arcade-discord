...
const naudiodon_1 = require("naudiodon");
    ...
    async connectToSession(options, token, username) {
        ...
        return new Promise(resolve => {
            liveKitRoom.once('trackSubscribed', async (track) => {
                ...
                if (microphoneId) {
                    const microphoneIO = (0, naudiodon_1.AudioIO)({
                        inOptions: {
                            channelCount: 1,
                            sampleFormat: naudiodon_1.SampleFormat16Bit,
                            sampleRate: 48000,
                ...
                if (speakerId) {
                    const speakerIO = (0, naudiodon_1.AudioIO)({
                        outOptions: {
                            channelCount: 1,
                            sampleFormat: naudiodon_1.SampleFormat16Bit,
                            sampleRate: 48000,
